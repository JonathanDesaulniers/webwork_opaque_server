...
sub start {
    my $self = shift;
	my ($questionid, $questionversion, $questionhint, $questionsolution, $endingquestionsolution, $modeexam, $url, $initialParamNames, $initialParamValues,$cachedResources) = @_;	
